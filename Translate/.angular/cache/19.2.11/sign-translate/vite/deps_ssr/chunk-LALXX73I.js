...
// node_modules/@sutton-signwriting/sgnw-components/dist/esm/draggabilly-b10e2ab0.js
...
var unidragger = createCommonjsModule(function(module) {
  (function(window2, factory) {
    if (module.exports) {
      module.exports = factory(window2, evEmitter);
    } else {
...
var draggabilly = createCommonjsModule(function(module) {
  (function(window2, factory) {
    if (module.exports) {
      module.exports = factory(window2, getSize, unidragger);
    } else {
    ...
    proto.option = function(opts) {
      this.options = __spreadValues(__spreadValues({}, this.options), opts);
    };
    ...
    proto._create = function() {
      ...
      this.startPosition = __spreadValues({}, this.position);
...
@sutton-signwriting/sgnw-components/dist/esm/draggabilly-b10e2ab0.js:
  (*!
   ...
   *)
*/
//# sourceMappingURL=chunk-LALXX73I.js.map
