...
// node_modules/@sutton-signwriting/sgnw-components/dist/esm/fsw-bd4c9f61.js
var fsw = createCommonjsModule(function(module, exports) {
  (function(global, factory) {
    ...
    const symbolSize = function(fsw2) {
      return symbolSize$1(key2id(fsw2));
    };
    ...
    const symbolLine = function(fsw2) {
      return symbolLine$1(key2id(fsw2));
    };
    const symbolFill = function(fsw2) {
      return symbolFill$1(key2id(fsw2));
    };
    const symbolText = function(fsw2) {
      return symbolText$1(key2id(fsw2));
    };
    let re$2 = {
      "colorize": "C",
...
@sutton-signwriting/sgnw-components/dist/esm/fsw-bd4c9f61.js:
  (*!
   * The Sutton SignWriting Web Components
   *)
*/
//# sourceMappingURL=chunk-45O3HGS2.js.map
