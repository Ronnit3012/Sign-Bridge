...
var FetchConnection = class {
  ...
  send(url, method, isUsingEmulator, body, headers) {
    return __async(this, null, function* () {
      ...
      this.sent_ = true;
      try {
        const response = yield newFetch(url, method, isUsingEmulator, headers, body);
...
// node_modules/@capacitor-firebase/storage/dist/esm/web.js
var FirebaseStorageWeb = class _FirebaseStorageWeb extends WebPlugin {
  deleteFile(options) {
    return __async(this, null, function* () {
  ...
  listFiles(options) {
    return __async(this, null, function* () {
      ...
      const listResult = yield list(storageRef, listOptions);
      const result = {
  ...
  updateMetadata(options) {
    return __async(this, null, function* () {
      ...
      yield updateMetadata(storageRef, metadata);
    });
  }
  uploadFile(options, callback) {
    return __async(this, null, function* () {
      if (!options.blob) {
        throw new Error(_FirebaseStorageWeb.ERROR_BLOB_MISSING);
      }
      const storage = getStorage();
      const storageRef = ref(storage, options.path);
      let metadata;
...
@firebase/storage/dist/node-esm/index.node.esm.js:
   ...
   *)
*/
//# sourceMappingURL=web-MYX65JBU.js.map
