...
var font = _commonjsHelpers.createCommonjsModule(function (module, exports) {
/**
* Sutton SignWriting TrueType Font Module v1.4.2 (https://github.com/sutton-signwriting/font-ttf)
...
const cssValues = function (el) {
  ...
  let styleObj = {
    ...
    "detail": [
      style_min.rgb2hex(css.getPropertyValue("color")),
      style_min.rgb2hex(css.getPropertyValue("background-color"))
    ],
...
exports.cssValues = cssValues;
exports.hasSize = hasSize;
exports.iswa2010FSW = iswa2010FSW;
exports.iswa2010SWU = iswa2010SWU;
exports.overlap = overlap;
exports.padArray = padArray;
exports.padArrayInner = padArrayInner;
