...
${symbolSvgBody(swuSym)}
  ...
  const signSvgBody = swuSign => {
    let parsed = parse$2.sign(swuSign);
    const blank = '';
    if (parsed.spatials) {
      let styling = parse(parsed.style);
...
`;
  ...
  const signCanvas = function (swuSign) {
    const parsed = parse$2.sign(swuSign);
    if (parsed.spatials) {
      const canvas = document.createElement('canvas');
      const context = canvas.getContext('2d');
      let styling = parse(parsed.style);
  ...
  exports.symbolFlop = symbolFlop;
  exports.symbolInvert = symbolInvert;
  exports.symbolLine = symbolLine;
  exports.symbolMirror = symbolMirror;
  exports.symbolNormalize = symbolNormalize;
  exports.symbolPng = symbolPng;
  exports.symbolRotate = symbolRotate;
  exports.symbolScroll = symbolScroll;
